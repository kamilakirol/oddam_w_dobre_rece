...
const RegistrationForm = () => {
    ...
    const [registrationErrors, setRegistrationErrors] = useState<Partial<RegistrationFormProps>>({});
    ...
    const validate = (values: RegistrationFormProps) => {
        const errors: Partial<RegistrationFormProps> = {};
    ...
    return (
        <form className='login_form'
            ...
            <LoginButtons to='/logowanie' textLink='Zaloguj się' textSubmit='Załóż konto'/>
